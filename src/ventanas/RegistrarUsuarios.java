...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 210, -1));

        jLabel5.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Nombre de usuario:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 50, -1, -1));
        ...
        getContentPane().add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 140, 210, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 200, 120, 100));
            ...
            if(rs.next() ){
                ...
                if(validacion==0 ){
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Error al registrar, contacte al Admin");
                    }
                }else{
