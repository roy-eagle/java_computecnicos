...
public class login extends javax.swing.JFrame {
    ...
    public login() {
        ...
        ImageIcon wallpaper_logo = new ImageIcon("src/images/mantenimientos2.jpg");
    ...
    private void initComponents() {
        ...
        jButton_Acceder.setText("A C C E D E R");
        ...
        jLabel_Footer.setText("Creado por PEOPLE-NET (R) ");
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 500, -1, -1));
    ...
    private void jButton_AccederActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AccederActionPerformed
        ...
        if( !user.equals("") || !pass.equals("") ){
            try {
                ...
                System.out.println("Error boton aceder "+e);
                JOptionPane.showMessageDialog(null, "!!no puede iniciar sesiòn!!");
            }
        }else{
